...
fun Sample4_PerGraphTransitions(
    ...
    val previousState =
        androidx.compose.runtime.remember { mutableStateOf(navController.state) }

    val direction = navController.state.directionFrom(previousState.value)

    androidx.compose.runtime.LaunchedEffect(navController.state) {
