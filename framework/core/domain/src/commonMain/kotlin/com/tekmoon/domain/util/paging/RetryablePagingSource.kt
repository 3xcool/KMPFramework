...
abstract class RetryablePagingSource<T, K>(
     ...
     */
    abstract suspend fun fetchPage(page: Int, pageSize: Int): Result<List<T>, DataError.Remote>
    ...
    final override suspend fun loadRemotePage(
        page: Int,
        pageSize: Int,
    ): Result<List<T>, DataError.Remote> = withRetry(retryPolicy) { fetchPage(page, pageSize) }
}
