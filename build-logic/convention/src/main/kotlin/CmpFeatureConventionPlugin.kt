...
class CmpFeatureConventionPlugin: Plugin<Project> {
    ...
    override fun apply(target: Project) {
        with(target) {
            with(pluginManager) {
                apply("com.tekmoon.convention.cmp.library")
            }

            dependencies {
                "commonMainImplementation"(project("framework:core:domain"))
                "commonMainImplementation"(project("framework:core:presentation"))
                "commonMainImplementation"(project("framework:core:data"))
                "commonMainImplementation"(project("framework:core:designsystem"))
